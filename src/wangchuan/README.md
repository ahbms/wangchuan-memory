...
- [`docs/STORAGE.md`](../../docs/STORAGE.md) —— 数据路径、备份、恢复
- [`docs/FAQ.md`](../../docs/FAQ.md) —— 常见问题
- [`docs/API_CONTRACT.md`](../../docs/API_CONTRACT.md) —— 稳定公开 API 边界
- [`docs/DEPRECATION_POLICY.md`](../../docs/DEPRECATION_POLICY.md) —— 兼容性与弃用规则
- [`docs/TROUBLESHOOTING.md`](../../docs/TROUBLESHOOTING.md) —— 常见错误与处理
- [`docs/ALPHA_TRIAL_GUIDE.md`](../../docs/ALPHA_TRIAL_GUIDE.md) —— alpha 试用流程
- [`docs/FEEDBACK_TEMPLATE.md`](../../docs/FEEDBACK_TEMPLATE.md) —— 反馈模板
...
稳定契约参考：[`docs/API_CONTRACT.md`](../../docs/API_CONTRACT.md)
...
为兼容历史调用，当前仍可能存在额外可导入名称；但对新的外部集成，只以上面这组契约作为稳定承诺。
...
公开边界说明：
- 稳定外部接口见 [`docs/API_CONTRACT.md`](../../docs/API_CONTRACT.md)
- 弃用/兼容规则见 [`docs/DEPRECATION_POLICY.md`](../../docs/DEPRECATION_POLICY.md)
- `wangchuan.v3.*`、`wangchuan.memory_api`、`wangchuan.recall_service`、`wangchuan.runtime_state` 等路径默认视为 internal，不建议外部直接绑定
- `WangchuanPipeline` 当前可为兼容场景保留，但不是新的稳定集成首选入口
- 更完整的使用文档见 [`docs/QUICKSTART.md`](../../docs/QUICKSTART.md)、[`docs/CLI.md`](../../docs/CLI.md)、[`docs/MCP.md`](../../docs/MCP.md)、[`docs/STORAGE.md`](../../docs/STORAGE.md)、[`docs/FAQ.md`](../../docs/FAQ.md)、[`docs/ARCHITECTURE.md`](../../docs/ARCHITECTURE.md)、[`docs/TROUBLESHOOTING.md`](../../docs/TROUBLESHOOTING.md)、[`docs/ALPHA_TRIAL_GUIDE.md`](../../docs/ALPHA_TRIAL_GUIDE.md)、[`docs/FEEDBACK_TEMPLATE.md`](../../docs/FEEDBACK_TEMPLATE.md)
